...
llfs.pheno.dir <- "<Directory of Data>"

std.name.table.file <- "<Path to Supplementary Table S13>"

llfs.metab4.dir <- "<Directory of Metabolite Data Batch4>"

llfs.metab5.dir <- "<Directory of Metabolite Data Batch5>"
```

## Read in file
```{r}
llfs.data.batch4 <- read.csv(paste0(llfs.pheno.dir, 
                                    "<Phenotype Data Batch4 File Name>"), 
                             header=T, na.strings = c("", NA))

met.4.llfs <- readr::read_csv(paste0(llfs.metab4.dir,
                                     "<Metabolite Data Batch4 File Name>"))


llfs.data.batch5 <- read.csv(paste0(llfs.pheno.dir,
                              "<Phenotype Data Batch5 File Name>"), 
                             header=T, na.strings = c("", NA))

met.5.llfs <- readr::read_csv(paste0(llfs.metab5.dir,
                        "<Metabolite Data Batch5 File Name>"))
...
```{r  eval=FALSE}
source("<Network Function Script>")
